#Lance Miller
#This is a combination of our programming exercises and code that was demonstrated in our resources
...
#I used a string operator here to concatenate the users response with what I printed
print("In this project, I will be displaying the knowledge that I gain throughout this course.")
#I explained what this program is going to do to the user
favNum = input("What is your favorite whole number that is greater than 1 and less than 100? ")
#I require another input from the user here
print("Let's do some calculations using your favorite whole number that is greater than 1, which is", favNum + ".")
#Here I used the same string operator as before
print("The number you chose when added to the number five is:", int(favNum) + 5)
...
print("The remainder that is left over when this number is divided by 2 is:", int(favNum) % 2)
...
print("When we perform floor division on this number using the number 20, it results in:", int(numTwo) // 20)
#Here I used a numeric operator to perform floor division
print("In case you do not know, floor division is similar to regular division, but it will result in the largest possible whole number")
...
#Here I kind of converse with the user
print("For the second part of you surprise, I am once again going to ask you to pick a number, and you can pick any number at all this time")
#Here I print something for the user to see
print("Please do not pick too big of a number though, it might make my surprise less enjoyable.")
#Here I print something for the user to see
randomNum = input("After careful consideration, what is the number that you have chosen? ")
...
#Here my surprise the user with my surprise, by using a string operator to print something multiple times
print("Surprise! I bet you were not expecting that")
#Here I print something for the user to see
print("Anyway, enough with the games, there are some more things that I must show you.")
#Here I print something for the user to see
carnFood = input("If you were able to go to a carnival right this instant, what food would you buy? ")
#Here I require an input from the user
...
carnCost = float(input("Since I do not know, how much does one order of your chosen food cost? (Do not worry about the dollar sign) "))
...
#Here I require an input from the user
print("I do not know what you are expecting, but I am going to continue regardless lol")
#Here I print something for the user to see
print("The total cost of your purchase is... drum roll please.")
#Here I print something for the user to see
print("Your total cost is ", format(carnTotal, ".02f"), sep='$', end='!')
#Here I use a sep= and end= argument to show a total cost
carnivalAsking = input("\nWas I right? ")
#Here I require an input from the user
print("Who am I kidding, I know I am right!")
#Here I print something for the user to see
print("Do you remember how earlier I asked you to pick any whole number from 100 - 1000? You picked", numTwo + ".")
#Here I print something for the user to see
...
print("If you were to buy ", numTwo + " orders of that carnival food, it would cost $", format (carnTwo, ".02f"), sep='')
...
print("It does not matter what number you pick, but maybe avoid picking a large number.")
# I am addressing the user
...
print("Now, I will take a number you give me and set that as the radius of a circle.")
# I am addressing the user
...
# I am addressing the user
print("When you are done inputting numbers, enter the number 0, as that will let me know that you are done!")
# I am addressing the user
print("Do not worry, 0 will not be included in your list of numbers when I calculate the average of the list.")
# I am addressing the user
...
while value != 0:
    ...
    count += 1
    # I use a shortcut operator here, and I increase an existing variable by one
    value = int(input("Please enter a number: "))
# I am asking the user for an input
...
# I print something for the user
    ...
    # I create an else for when the user does not input either of the correct answers
...
if (coolNum >= 0 and coolNum <= 10):
    # I create an if for when two certain conditions are met by using "and" and some operators
    print("The number you gave me is in between 0 and 10, or is equal to 0 or 10.")
# I display something to the user
elif (coolNum < 0 or coolNum > 10):
    # I create an elif for when one of two conditions are met by using "or" and some operators
